...
public class Principal extends javax.swing.JFrame {
    ...
    public int convertirDecimal(int numero){
        ...
        for (contadorX = 0; contadorX < 8; contadorX++)
            {
                ...
                for (contadorY = 0; contadorY < 16; contadorY++)
                {
                    Tablero.remove(Botones[contadorX][contadorY]);
                    RedibujarTablero();
                }//Fin For - Y
            }//Fin For - X
    }
    ...
    public void colocarCarta(String z){
        ...
        num = convertirDecimal(num);
        numero = Integer.toString(num);
        posX = convertirDecimal(posX);
        posY = convertirDecimal(posY);
        
        if(color == 0000){
            Botones[posX][posY].setBackground(Color.YELLOW);         
        }
        else if(color == 0001){
            Botones[posX][posY].setBackground(Color.BLUE); 
        }
        else if(color == 10){
            Botones[posX][posY].setBackground(Color.RED);
        }
        else if(color == 11){
            Botones[posX][posY].setBackground(Color.BLACK);
        }
        
            Botones[posX][posY].setText(numero);
            RedibujarTablero();
    }
